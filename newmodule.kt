...
fun main(args: Array<String>) {
    ...
    // 3. Start workflow https://github.com/omarmiatello/source-of-truth/actions/workflows/build-modules.yaml
    val config = ScriptGradleModuleConfig(
        gradleConfig = GradleConfig(
            packagePrefix = "com.github.omarmiatello.sourceoftruth",
