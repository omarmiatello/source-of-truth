        ...
        publications {
            create<MavenPublication>("release") {
                ...
                pom {
                    ...
                    name.set("source-of-truth:$artifactId")
                    description.set(project.description)
                    url.set("https://github.com/omarmiatello/source-of-truth/")
                    ...
                    scm {
                        connection.set("scm:git:git://github.com/omarmiatello/source-of-truth.git")
                        developerConnection.set("scm:git:ssh://github.com/omarmiatello/source-of-truth.git")
                        url.set("https://github.com/omarmiatello/source-of-truth/")
                    }
                    issueManagement {
                        system.set("GitHub Issues")
                        url.set("https://github.com/omarmiatello/source-of-truth/issues")
                    }
                }
            }
        }
