...
object Lib {
    const val androidxActivityKtx = "androidx.activity:activity-ktx:1.6.0-beta01"
    ...
    const val composeActivity = "androidx.activity:activity-compose:1.6.0-beta01"
    const val composeFoundation = "androidx.compose.foundation:foundation:1.3.0-alpha03"
    const val composeIconsCore = "androidx.compose.material:material-icons-core:1.3.0-alpha03"
    const val composeIconsExt = "androidx.compose.material:material-icons-extended:1.3.0-alpha03"
    const val composeMaterial = "androidx.compose.material:material:1.3.0-alpha03"
    const val composeUi = "androidx.compose.ui:ui:1.3.0-alpha03"
    const val composeUiTooling = "androidx.compose.ui:ui-tooling:1.3.0-alpha03"
