...
object Lib {
    ...
    const val androidxLifecycleRuntimeKtx = "androidx.lifecycle:lifecycle-runtime-ktx:2.7.0-rc02"
    ...
    const val androidxViewmodelKtx = "androidx.lifecycle:lifecycle-viewmodel-ktx:2.7.0-rc02"
    ...
    const val composeFoundation = "androidx.compose.foundation:foundation:1.6.0-beta03"
    const val composeIconsCore = "androidx.compose.material:material-icons-core:1.6.0-beta03"
    const val composeIconsExt = "androidx.compose.material:material-icons-extended:1.6.0-beta03"
    const val composeMaterial = "androidx.compose.material:material:1.6.0-beta03"
