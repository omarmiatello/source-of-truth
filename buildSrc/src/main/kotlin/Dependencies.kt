...
object Lib {
    const val androidxActivityKtx = "androidx.activity:activity-ktx:1.10.1"
    ...
    const val androidxCoreKtx = "androidx.core:core-ktx:1.16.0-alpha02"
    ...
    const val androidxViewmodelKtx = "androidx.lifecycle:lifecycle-viewmodel-ktx:2.9.0-alpha10"
    ...
    const val composeFoundation = "androidx.compose.foundation:foundation:1.8.0-beta02"
    ...
    const val composeMaterial = "androidx.compose.material:material:1.8.0-beta02"
    const val composeUi = "androidx.compose.ui:ui:1.8.0-beta02"
    const val composeUiTooling = "androidx.compose.ui:ui-tooling:1.8.0-beta02"
    const val composeViewmodel = "androidx.lifecycle:lifecycle-viewmodel-compose:2.9.0-alpha10"
    ...
    const val kotlinReflect = "org.jetbrains.kotlin:kotlin-reflect:2.1.20"
    ...
    const val testAndroidxEspresso = "androidx.test.espresso:espresso-core:3.7.0-alpha01"
    const val testAndroidxExtJunit = "androidx.test.ext:junit:1.3.0-alpha01"
    const val testAndroidxRules = "androidx.test:rules:1.7.0-alpha01"
    const val testAndroidxRunner = "androidx.test:runner:1.7.0-alpha01"
