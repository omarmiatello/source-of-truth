...
object Lib {
    const val androidxActivityKtx = "androidx.activity:activity-ktx:1.8.0-alpha02"
    const val androidxAppcompat = "androidx.appcompat:appcompat:1.7.0-alpha02"
    ...
    const val androidxCoreKtx = "androidx.core:core-ktx:1.12.0-alpha01"
    const val androidxFragmentKtx = "androidx.fragment:fragment-ktx:1.6.0-alpha08"
    const val androidxLifecycleRuntimeKtx = "androidx.lifecycle:lifecycle-runtime-ktx:2.6.1"
    ...
    const val androidxViewmodelKtx = "androidx.lifecycle:lifecycle-viewmodel-ktx:2.6.1"
    const val composeAccompanistCoil = "com.google.accompanist:accompanist-coil:0.15.0"
    const val composeActivity = "androidx.activity:activity-compose:1.8.0-alpha02"
    const val composeFoundation = "androidx.compose.foundation:foundation:1.5.0-alpha01"
    const val composeIconsCore = "androidx.compose.material:material-icons-core:1.5.0-alpha01"
    const val composeIconsExt = "androidx.compose.material:material-icons-extended:1.5.0-alpha01"
    const val composeMaterial = "androidx.compose.material:material:1.5.0-alpha01"
    const val composeUi = "androidx.compose.ui:ui:1.5.0-alpha01"
    const val composeUiTooling = "androidx.compose.ui:ui-tooling:1.5.0-alpha01"
    const val composeViewmodel = "androidx.lifecycle:lifecycle-viewmodel-compose:2.6.1"
    const val coroutinesAndroid = "org.jetbrains.kotlinx:kotlinx-coroutines-android:1.7.0-Beta"
    const val coroutinesCore = "org.jetbrains.kotlinx:kotlinx-coroutines-core:1.7.0-Beta"
    ...
    const val kotlinReflect = "org.jetbrains.kotlin:kotlin-reflect:1.8.20-RC2"
    ...
    const val testAndroidxEspresso = "androidx.test.espresso:espresso-core:3.6.0-alpha01"
    const val testAndroidxExtJunit = "androidx.test.ext:junit:1.2.0-alpha01"
    const val testAndroidxRules = "androidx.test:rules:1.6.0-alpha01"
    const val testAndroidxRunner = "androidx.test:runner:1.6.0-alpha01"
