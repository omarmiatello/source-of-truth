...
object Lib {
    const val androidxActivityKtx = "androidx.activity:activity-ktx:1.8.0-alpha05"
    ...
    const val androidxCoreKtx = "androidx.core:core-ktx:1.12.0-alpha05"
    const val androidxFragmentKtx = "androidx.fragment:fragment-ktx:1.7.0-alpha01"
    ...
    const val composeActivity = "androidx.activity:activity-compose:1.8.0-alpha05"
    const val composeFoundation = "androidx.compose.foundation:foundation:1.5.0-beta02"
    const val composeIconsCore = "androidx.compose.material:material-icons-core:1.5.0-beta02"
    const val composeIconsExt = "androidx.compose.material:material-icons-extended:1.5.0-beta02"
    const val composeMaterial = "androidx.compose.material:material:1.5.0-beta02"
    const val composeUi = "androidx.compose.ui:ui:1.5.0-beta02"
    const val composeUiTooling = "androidx.compose.ui:ui-tooling:1.5.0-beta02"
    const val composeViewmodel = "androidx.lifecycle:lifecycle-viewmodel-compose:2.6.1"
    const val coroutinesAndroid = "org.jetbrains.kotlinx:kotlinx-coroutines-android:1.7.2"
    ...
    const val kotlinReflect = "org.jetbrains.kotlin:kotlin-reflect:1.9.0-RC"
    ...
    const val testAndroidxRunner = "androidx.test:runner:1.6.0-alpha02"
