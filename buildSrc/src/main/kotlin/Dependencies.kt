...
object Lib {
    const val androidxActivityKtx = "androidx.activity:activity-ktx:1.8.1"
    ...
    const val androidxCoreKtx = "androidx.core:core-ktx:1.13.0-alpha01"
    const val androidxFragmentKtx = "androidx.fragment:fragment-ktx:1.7.0-alpha06"
    ...
    const val composeFoundation = "androidx.compose.foundation:foundation:1.6.0-beta01"
    const val composeIconsCore = "androidx.compose.material:material-icons-core:1.6.0-beta01"
    const val composeIconsExt = "androidx.compose.material:material-icons-extended:1.6.0-beta01"
    const val composeMaterial = "androidx.compose.material:material:1.6.0-beta01"
    const val composeUi = "androidx.compose.ui:ui:1.6.0-beta01"
    const val composeUiTooling = "androidx.compose.ui:ui-tooling:1.6.0-beta01"
