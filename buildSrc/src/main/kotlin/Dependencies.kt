...
object Lib {
    const val androidxActivityKtx = "androidx.activity:activity-ktx:1.9.0-alpha01"
    ...
    const val androidxCoreKtx = "androidx.core:core-ktx:1.13.0-alpha02"
    const val androidxFragmentKtx = "androidx.fragment:fragment-ktx:1.7.0-alpha07"
    const val androidxLifecycleRuntimeKtx = "androidx.lifecycle:lifecycle-runtime-ktx:2.7.0-rc01"
    ...
    const val androidxViewmodelKtx = "androidx.lifecycle:lifecycle-viewmodel-ktx:2.7.0-rc01"
    const val composeAccompanistCoil = "com.google.accompanist:accompanist-coil:0.15.0"
    const val composeActivity = "androidx.activity:activity-compose:1.9.0-alpha01"
    const val composeFoundation = "androidx.compose.foundation:foundation:1.6.0-beta02"
    const val composeIconsCore = "androidx.compose.material:material-icons-core:1.6.0-beta02"
    const val composeIconsExt = "androidx.compose.material:material-icons-extended:1.6.0-beta02"
    const val composeMaterial = "androidx.compose.material:material:1.6.0-beta02"
    const val composeUi = "androidx.compose.ui:ui:1.6.0-beta02"
    const val composeUiTooling = "androidx.compose.ui:ui-tooling:1.6.0-beta02"
    const val composeViewmodel = "androidx.lifecycle:lifecycle-viewmodel-compose:2.7.0-rc01"
    ...
    const val kotlinReflect = "org.jetbrains.kotlin:kotlin-reflect:2.0.0-Beta1"
    ...
    const val testAndroidxEspresso = "androidx.test.espresso:espresso-core:3.6.0-alpha02"
    const val testAndroidxExtJunit = "androidx.test.ext:junit:1.2.0-alpha02"
    const val testAndroidxRules = "androidx.test:rules:1.6.0-alpha02"
    const val testAndroidxRunner = "androidx.test:runner:1.6.0-alpha05"
