...
object Lib {
    ...
    const val androidxCoreKtx = "androidx.core:core-ktx:1.15.0-beta01"
    const val androidxFragmentKtx = "androidx.fragment:fragment-ktx:1.8.4"
    const val androidxLifecycleRuntimeKtx = "androidx.lifecycle:lifecycle-runtime-ktx:2.9.0-alpha04"
    ...
    const val androidxViewmodelKtx = "androidx.lifecycle:lifecycle-viewmodel-ktx:2.9.0-alpha04"
    ...
    const val composeFoundation = "androidx.compose.foundation:foundation:1.8.0-alpha03"
    const val composeIconsCore = "androidx.compose.material:material-icons-core:1.7.3"
    const val composeIconsExt = "androidx.compose.material:material-icons-extended:1.7.3"
    const val composeMaterial = "androidx.compose.material:material:1.8.0-alpha03"
    const val composeUi = "androidx.compose.ui:ui:1.8.0-alpha03"
    const val composeUiTooling = "androidx.compose.ui:ui-tooling:1.8.0-alpha03"
    const val composeViewmodel = "androidx.lifecycle:lifecycle-viewmodel-compose:2.9.0-alpha04"
