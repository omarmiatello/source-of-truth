...
object Lib {
    const val androidxActivityKtx = "androidx.activity:activity-ktx:1.4.0-alpha02"
    const val androidxAppcompat = "androidx.appcompat:appcompat:1.4.0-alpha03"
    ...
    const val androidxCoreKtx = "androidx.core:core-ktx:1.7.0-beta01"
    const val androidxFragmentKtx = "androidx.fragment:fragment-ktx:1.4.0-alpha09"
    const val androidxLifecycleRuntimeKtx = "androidx.lifecycle:lifecycle-runtime-ktx:2.4.0-beta01"
    ...
    const val androidxViewmodelKtx = "androidx.lifecycle:lifecycle-viewmodel-ktx:2.4.0-beta01"
    const val composeAccompanistCoil = "com.google.accompanist:accompanist-coil:0.15.0"
    const val composeActivity = "androidx.activity:activity-compose:1.4.0-alpha02"
    const val composeFoundation = "androidx.compose.foundation:foundation:1.1.0-alpha04"
    const val composeIconsCore = "androidx.compose.material:material-icons-core:1.1.0-alpha04"
    const val composeIconsExt = "androidx.compose.material:material-icons-extended:1.1.0-alpha04"
    const val composeMaterial = "androidx.compose.material:material:1.1.0-alpha04"
    const val composeUi = "androidx.compose.ui:ui:1.1.0-alpha04"
    const val composeUiTooling = "androidx.compose.ui:ui-tooling:1.1.0-alpha04"
    const val composeViewmodel = "androidx.lifecycle:lifecycle-viewmodel-compose:2.4.0-beta01"
    ...
    const val kotlinReflect = "org.jetbrains.kotlin:kotlin-reflect:1.5.31"
    ...
    const val testAndroidxEspresso = "androidx.test.espresso:espresso-core:3.5.0-alpha01"
    const val testAndroidxExtJunit = "androidx.test.ext:junit:1.1.4-alpha01"
    const val testAndroidxRules = "androidx.test:rules:1.4.1-alpha01"
    const val testAndroidxRunner = "androidx.test:runner:1.4.1-alpha01"
