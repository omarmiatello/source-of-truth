...
object Lib {
    ...
    const val androidxCoreKtx = "androidx.core:core-ktx:1.13.0-alpha03"
    const val androidxFragmentKtx = "androidx.fragment:fragment-ktx:1.7.0-alpha08"
    const val androidxLifecycleRuntimeKtx = "androidx.lifecycle:lifecycle-runtime-ktx:2.7.0"
    ...
    const val androidxViewmodelKtx = "androidx.lifecycle:lifecycle-viewmodel-ktx:2.7.0"
    ...
    const val composeFoundation = "androidx.compose.foundation:foundation:1.6.0-rc01"
    const val composeIconsCore = "androidx.compose.material:material-icons-core:1.6.0-rc01"
    const val composeIconsExt = "androidx.compose.material:material-icons-extended:1.6.0-rc01"
    const val composeMaterial = "androidx.compose.material:material:1.6.0-rc01"
    const val composeUi = "androidx.compose.ui:ui:1.6.0-rc01"
    const val composeUiTooling = "androidx.compose.ui:ui-tooling:1.6.0-rc01"
    ...
    const val kotlinReflect = "org.jetbrains.kotlin:kotlin-reflect:2.0.0-Beta2"
