...
object Lib {
    const val androidxActivityKtx = "androidx.activity:activity-ktx:1.6.0-alpha05"
    const val androidxAppcompat = "androidx.appcompat:appcompat:1.6.0-alpha05"
    ...
    const val androidxFragmentKtx = "androidx.fragment:fragment-ktx:1.5.0-rc01"
    const val androidxLifecycleRuntimeKtx = "androidx.lifecycle:lifecycle-runtime-ktx:2.5.0-rc02"
    ...
    const val androidxViewmodelKtx = "androidx.lifecycle:lifecycle-viewmodel-ktx:2.5.0-rc02"
    const val composeAccompanistCoil = "com.google.accompanist:accompanist-coil:0.15.0"
    const val composeActivity = "androidx.activity:activity-compose:1.6.0-alpha05"
    const val composeFoundation = "androidx.compose.foundation:foundation:1.2.0-rc01"
    const val composeIconsCore = "androidx.compose.material:material-icons-core:1.2.0-rc01"
    const val composeIconsExt = "androidx.compose.material:material-icons-extended:1.2.0-rc01"
    const val composeMaterial = "androidx.compose.material:material:1.2.0-rc01"
    const val composeUi = "androidx.compose.ui:ui:1.2.0-rc01"
    const val composeUiTooling = "androidx.compose.ui:ui-tooling:1.2.0-rc01"
    const val composeViewmodel = "androidx.lifecycle:lifecycle-viewmodel-compose:2.5.0-rc02"
    const val coroutinesAndroid = "org.jetbrains.kotlinx:kotlinx-coroutines-android:1.6.3"
    const val coroutinesCore = "org.jetbrains.kotlinx:kotlinx-coroutines-core:1.6.3"
    ...
    const val kotlinReflect = "org.jetbrains.kotlin:kotlin-reflect:1.7.0"
    ...
    const val testAndroidxEspresso = "androidx.test.espresso:espresso-core:3.5.0-alpha07"
    const val testAndroidxExtJunit = "androidx.test.ext:junit:1.1.4-alpha07"
    const val testAndroidxRules = "androidx.test:rules:1.4.1-alpha07"
    const val testAndroidxRunner = "androidx.test:runner:1.5.0-alpha04"
