...
object Lib {
    const val androidxActivityKtx = "androidx.activity:activity-ktx:1.10.0-alpha02"
    ...
    const val androidxCoreKtx = "androidx.core:core-ktx:1.15.0-alpha02"
    const val androidxFragmentKtx = "androidx.fragment:fragment-ktx:1.8.3"
    const val androidxLifecycleRuntimeKtx = "androidx.lifecycle:lifecycle-runtime-ktx:2.9.0-alpha03"
    ...
    const val androidxViewmodelKtx = "androidx.lifecycle:lifecycle-viewmodel-ktx:2.9.0-alpha03"
    const val composeAccompanistCoil = "com.google.accompanist:accompanist-coil:0.15.0"
    const val composeActivity = "androidx.activity:activity-compose:1.10.0-alpha02"
    const val composeFoundation = "androidx.compose.foundation:foundation:1.8.0-alpha02"
    const val composeIconsCore = "androidx.compose.material:material-icons-core:1.7.2"
    const val composeIconsExt = "androidx.compose.material:material-icons-extended:1.7.2"
    const val composeMaterial = "androidx.compose.material:material:1.8.0-alpha02"
    const val composeUi = "androidx.compose.ui:ui:1.8.0-alpha02"
    const val composeUiTooling = "androidx.compose.ui:ui-tooling:1.8.0-alpha02"
    const val composeViewmodel = "androidx.lifecycle:lifecycle-viewmodel-compose:2.9.0-alpha03"
    const val coroutinesAndroid = "org.jetbrains.kotlinx:kotlinx-coroutines-android:1.9.0"
    ...
    const val kotlinReflect = "org.jetbrains.kotlin:kotlin-reflect:2.1.0-Beta1"
