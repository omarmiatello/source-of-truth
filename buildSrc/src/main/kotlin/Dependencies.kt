...
object Lib {
    ...
    const val androidxCoreKtx = "androidx.core:core-ktx:1.8.0-alpha02"
    ...
    const val composeFoundation = "androidx.compose.foundation:foundation:1.1.0-rc01"
    const val composeIconsCore = "androidx.compose.material:material-icons-core:1.1.0-rc01"
    const val composeIconsExt = "androidx.compose.material:material-icons-extended:1.1.0-rc01"
    const val composeMaterial = "androidx.compose.material:material:1.1.0-rc01"
    const val composeUi = "androidx.compose.ui:ui:1.1.0-rc01"
    const val composeUiTooling = "androidx.compose.ui:ui-tooling:1.1.0-rc01"
    const val composeViewmodel = "androidx.lifecycle:lifecycle-viewmodel-compose:2.4.0"
    const val coroutinesAndroid = "org.jetbrains.kotlinx:kotlinx-coroutines-android:1.6.0-RC3"
