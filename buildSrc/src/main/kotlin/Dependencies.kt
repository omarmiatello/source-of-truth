...
object Lib {
    const val androidxActivityKtx = "androidx.activity:activity-ktx:1.3.1"
    ...
    const val composeFoundation = "androidx.compose.foundation:foundation:1.0.2"
    const val composeIconsCore = "androidx.compose.material:material-icons-core:1.0.2"
    const val composeIconsExt = "androidx.compose.material:material-icons-extended:1.0.2"
    const val composeMaterial = "androidx.compose.material:material:1.0.2"
    const val composeUi = "androidx.compose.ui:ui:1.0.2"
    const val composeUiTooling = "androidx.compose.ui:ui-tooling:1.0.2"
