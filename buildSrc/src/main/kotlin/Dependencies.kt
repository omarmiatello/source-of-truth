...
object Lib {
    const val androidxActivityKtx = "androidx.activity:activity-ktx:1.6.0"
    const val androidxAppcompat = "androidx.appcompat:appcompat:1.6.0-rc01"
    ...
    const val androidxFragmentKtx = "androidx.fragment:fragment-ktx:1.6.0-alpha02"
    const val androidxLifecycleRuntimeKtx = "androidx.lifecycle:lifecycle-runtime-ktx:2.6.0-alpha02"
    ...
    const val androidxViewmodelKtx = "androidx.lifecycle:lifecycle-viewmodel-ktx:2.6.0-alpha02"
    ...
    const val composeFoundation = "androidx.compose.foundation:foundation:1.3.0-beta03"
    const val composeIconsCore = "androidx.compose.material:material-icons-core:1.3.0-beta03"
    const val composeIconsExt = "androidx.compose.material:material-icons-extended:1.3.0-beta03"
    const val composeMaterial = "androidx.compose.material:material:1.3.0-beta03"
    const val composeUi = "androidx.compose.ui:ui:1.3.0-beta03"
    const val composeUiTooling = "androidx.compose.ui:ui-tooling:1.3.0-beta03"
    const val composeViewmodel = "androidx.lifecycle:lifecycle-viewmodel-compose:2.6.0-alpha02"
    ...
    const val kotlinReflect = "org.jetbrains.kotlin:kotlin-reflect:1.7.20-RC"
