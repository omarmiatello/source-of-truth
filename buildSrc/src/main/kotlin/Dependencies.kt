...
object Lib {
    ...
    const val composeFoundation = "androidx.compose.foundation:foundation:1.6.0"
    const val composeIconsCore = "androidx.compose.material:material-icons-core:1.6.0"
    const val composeIconsExt = "androidx.compose.material:material-icons-extended:1.6.0"
    const val composeMaterial = "androidx.compose.material:material:1.6.0"
    const val composeUi = "androidx.compose.ui:ui:1.6.0"
    const val composeUiTooling = "androidx.compose.ui:ui-tooling:1.6.0"
