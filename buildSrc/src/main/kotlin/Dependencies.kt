...
object Lib {
    const val androidxActivityKtx = "androidx.activity:activity-ktx:1.4.0-beta01"
    const val androidxAppcompat = "androidx.appcompat:appcompat:1.4.0-beta01"
    ...
    const val androidxCoreKtx = "androidx.core:core-ktx:1.7.0-beta02"
    const val androidxFragmentKtx = "androidx.fragment:fragment-ktx:1.4.0-alpha10"
    const val androidxLifecycleRuntimeKtx = "androidx.lifecycle:lifecycle-runtime-ktx:2.4.0-rc01"
    ...
    const val androidxViewmodelKtx = "androidx.lifecycle:lifecycle-viewmodel-ktx:2.4.0-rc01"
    const val composeAccompanistCoil = "com.google.accompanist:accompanist-coil:0.15.0"
    const val composeActivity = "androidx.activity:activity-compose:1.4.0-beta01"
    const val composeFoundation = "androidx.compose.foundation:foundation:1.1.0-alpha05"
    const val composeIconsCore = "androidx.compose.material:material-icons-core:1.1.0-alpha05"
    const val composeIconsExt = "androidx.compose.material:material-icons-extended:1.1.0-alpha05"
    const val composeMaterial = "androidx.compose.material:material:1.1.0-alpha05"
    const val composeUi = "androidx.compose.ui:ui:1.1.0-alpha05"
    const val composeUiTooling = "androidx.compose.ui:ui-tooling:1.1.0-alpha05"
