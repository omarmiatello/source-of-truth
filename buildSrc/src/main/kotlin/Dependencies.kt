...
object Lib {
    ...
    const val androidxCoreKtx = "androidx.core:core-ktx:1.8.0-alpha01"
    ...
    const val androidxViewmodelKtx = "androidx.lifecycle:lifecycle-viewmodel-ktx:2.4.0"
    const val composeAccompanistCoil = "com.google.accompanist:accompanist-coil:0.15.0"
    const val composeActivity = "androidx.activity:activity-compose:1.4.0"
    const val composeFoundation = "androidx.compose.foundation:foundation:1.1.0-beta04"
    const val composeIconsCore = "androidx.compose.material:material-icons-core:1.1.0-beta04"
    const val composeIconsExt = "androidx.compose.material:material-icons-extended:1.1.0-beta04"
    const val composeMaterial = "androidx.compose.material:material:1.1.0-beta04"
    const val composeUi = "androidx.compose.ui:ui:1.1.0-beta04"
    const val composeUiTooling = "androidx.compose.ui:ui-tooling:1.1.0-beta04"
    const val composeViewmodel = "androidx.lifecycle:lifecycle-viewmodel-compose:2.4.0"
    const val coroutinesAndroid = "org.jetbrains.kotlinx:kotlinx-coroutines-android:1.6.0-RC2"
