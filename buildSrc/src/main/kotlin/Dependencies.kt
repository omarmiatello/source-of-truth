...
object Lib {
    const val androidxActivityKtx = "androidx.activity:activity-ktx:1.10.0-rc01"
    ...
    const val androidxCoreKtx = "androidx.core:core-ktx:1.16.0-alpha01"
    ...
    const val androidxViewmodelKtx = "androidx.lifecycle:lifecycle-viewmodel-ktx:2.9.0-alpha08"
    const val composeAccompanistCoil = "com.google.accompanist:accompanist-coil:0.15.0"
    const val composeActivity = "androidx.activity:activity-compose:1.10.0-rc01"
    const val composeFoundation = "androidx.compose.foundation:foundation:1.8.0-alpha07"
    const val composeIconsCore = "androidx.compose.material:material-icons-core:1.7.6"
    const val composeIconsExt = "androidx.compose.material:material-icons-extended:1.7.6"
    const val composeMaterial = "androidx.compose.material:material:1.8.0-alpha07"
    const val composeUi = "androidx.compose.ui:ui:1.8.0-alpha07"
    const val composeUiTooling = "androidx.compose.ui:ui-tooling:1.8.0-alpha07"
    const val composeViewmodel = "androidx.lifecycle:lifecycle-viewmodel-compose:2.9.0-alpha08"
    ...
    const val kotlinReflect = "org.jetbrains.kotlin:kotlin-reflect:2.1.0"
