...
object Lib {
    ...
    const val androidxFragmentKtx = "androidx.fragment:fragment-ktx:1.4.0-beta01"
    ...
    const val composeFoundation = "androidx.compose.foundation:foundation:1.1.0-beta01"
    const val composeIconsCore = "androidx.compose.material:material-icons-core:1.1.0-beta01"
    const val composeIconsExt = "androidx.compose.material:material-icons-extended:1.1.0-beta01"
    const val composeMaterial = "androidx.compose.material:material:1.1.0-beta01"
    const val composeUi = "androidx.compose.ui:ui:1.1.0-beta01"
    const val composeUiTooling = "androidx.compose.ui:ui-tooling:1.1.0-beta01"
