...
object Lib {
    ...
    const val androidxViewmodelKtx = "androidx.lifecycle:lifecycle-viewmodel-ktx:2.6.0-alpha01"
    ...
    const val composeFoundation = "androidx.compose.foundation:foundation:1.3.0-alpha01"
    const val composeIconsCore = "androidx.compose.material:material-icons-core:1.3.0-alpha01"
    const val composeIconsExt = "androidx.compose.material:material-icons-extended:1.3.0-alpha01"
    const val composeMaterial = "androidx.compose.material:material:1.3.0-alpha01"
    const val composeUi = "androidx.compose.ui:ui:1.3.0-alpha01"
    const val composeUiTooling = "androidx.compose.ui:ui-tooling:1.3.0-alpha01"
    const val composeViewmodel = "androidx.lifecycle:lifecycle-viewmodel-compose:2.6.0-alpha01"
