...
object Lib {
    ...
    const val androidxFragmentKtx = "androidx.fragment:fragment-ktx:1.8.5"
    const val androidxLifecycleRuntimeKtx = "androidx.lifecycle:lifecycle-runtime-ktx:2.9.0-alpha09"
    ...
    const val androidxViewmodelKtx = "androidx.lifecycle:lifecycle-viewmodel-ktx:2.9.0-alpha09"
    ...
    const val composeFoundation = "androidx.compose.foundation:foundation:1.8.0-beta01"
    const val composeIconsCore = "androidx.compose.material:material-icons-core:1.7.7"
    const val composeIconsExt = "androidx.compose.material:material-icons-extended:1.7.7"
    const val composeMaterial = "androidx.compose.material:material:1.8.0-beta01"
    const val composeUi = "androidx.compose.ui:ui:1.8.0-beta01"
    const val composeUiTooling = "androidx.compose.ui:ui-tooling:1.8.0-beta01"
    const val composeViewmodel = "androidx.lifecycle:lifecycle-viewmodel-compose:2.9.0-alpha09"
