...
object Lib {
    const val androidxActivityKtx = "androidx.activity:activity-ktx:1.3.0-beta02"
    const val androidxAppcompat = "androidx.appcompat:appcompat:1.4.0-alpha02"
    ...
    const val androidxCoreKtx = "androidx.core:core-ktx:1.6.0-rc01"
    const val androidxFragmentKtx = "androidx.fragment:fragment-ktx:1.4.0-alpha03"
    const val androidxLifecycleRuntimeKtx = "androidx.lifecycle:lifecycle-runtime-ktx:2.4.0-alpha02"
    ...
    const val androidxViewmodelKtx = "androidx.lifecycle:lifecycle-viewmodel-ktx:2.4.0-alpha02"
    const val composeAccompanistCoil = "com.google.accompanist:accompanist-coil:0.12.0"
    const val composeActivity = "androidx.activity:activity-compose:1.3.0-beta02"
    const val composeFoundation = "androidx.compose.foundation:foundation:1.0.0-beta09"
    const val composeIconsCore = "androidx.compose.material:material-icons-core:1.0.0-beta09"
    const val composeIconsExt = "androidx.compose.material:material-icons-extended:1.0.0-beta09"
    const val composeMaterial = "androidx.compose.material:material:1.0.0-beta09"
    const val composeUi = "androidx.compose.ui:ui:1.0.0-beta09"
    ...
    const val kotlinReflect = "org.jetbrains.kotlin:kotlin-reflect:1.5.20-RC"
    ...
    const val testAndroidxEspresso = "androidx.test.espresso:espresso-core:3.4.0-rc01"
    const val testAndroidxExtJunit = "androidx.test.ext:junit:1.1.3-rc01"
    const val testAndroidxRules = "androidx.test:rules:1.4.0-rc01"
    const val testAndroidxRunner = "androidx.test:runner:1.4.0-rc01"
