...
object Lib {
    const val androidxActivityKtx = "androidx.activity:activity-ktx:1.3.0-rc02"
    ...
    const val androidxFragmentKtx = "androidx.fragment:fragment-ktx:1.4.0-alpha05"
    ...
    const val composeAccompanistCoil = "com.google.accompanist:accompanist-coil:0.14.0"
    const val composeActivity = "androidx.activity:activity-compose:1.3.0-rc02"
    const val composeFoundation = "androidx.compose.foundation:foundation:1.0.0-rc02"
    const val composeIconsCore = "androidx.compose.material:material-icons-core:1.0.0-rc02"
    const val composeIconsExt = "androidx.compose.material:material-icons-extended:1.0.0-rc02"
    const val composeMaterial = "androidx.compose.material:material:1.0.0-rc02"
    const val composeUi = "androidx.compose.ui:ui:1.0.0-rc02"
    const val composeUiTooling = "androidx.compose.ui:ui-tooling:1.0.0-rc02"
    ...
    const val kotlinReflect = "org.jetbrains.kotlin:kotlin-reflect:1.5.30-M1"
