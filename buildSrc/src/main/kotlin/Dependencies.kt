...
object Lib {
    ...
    const val composeFoundation = "androidx.compose.foundation:foundation:1.0.1"
    const val composeIconsCore = "androidx.compose.material:material-icons-core:1.0.1"
    const val composeIconsExt = "androidx.compose.material:material-icons-extended:1.0.1"
    const val composeMaterial = "androidx.compose.material:material:1.0.1"
    const val composeUi = "androidx.compose.ui:ui:1.0.1"
