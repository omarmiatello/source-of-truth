...
object Lib {
    ...
    const val androidxFragmentKtx = "androidx.fragment:fragment-ktx:1.6.0-alpha04"
    ...
    const val composeFoundation = "androidx.compose.foundation:foundation:1.4.0-alpha03"
    const val composeIconsCore = "androidx.compose.material:material-icons-core:1.4.0-alpha03"
    const val composeIconsExt = "androidx.compose.material:material-icons-extended:1.4.0-alpha03"
    const val composeMaterial = "androidx.compose.material:material:1.4.0-alpha03"
    const val composeUi = "androidx.compose.ui:ui:1.4.0-alpha03"
    const val composeUiTooling = "androidx.compose.ui:ui-tooling:1.4.0-alpha03"
    ...
    const val kotlinReflect = "org.jetbrains.kotlin:kotlin-reflect:1.8.0-RC"
