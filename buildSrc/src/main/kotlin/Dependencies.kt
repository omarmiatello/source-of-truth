...
object Lib {
    const val androidxActivityKtx = "androidx.activity:activity-ktx:1.6.0-alpha01"
    ...
    const val androidxCoreKtx = "androidx.core:core-ktx:1.9.0-alpha02"
    const val androidxFragmentKtx = "androidx.fragment:fragment-ktx:1.5.0-alpha04"
    const val androidxLifecycleRuntimeKtx = "androidx.lifecycle:lifecycle-runtime-ktx:2.5.0-alpha05"
    ...
    const val androidxViewmodelKtx = "androidx.lifecycle:lifecycle-viewmodel-ktx:2.5.0-alpha05"
    const val composeAccompanistCoil = "com.google.accompanist:accompanist-coil:0.15.0"
    const val composeActivity = "androidx.activity:activity-compose:1.6.0-alpha01"
    const val composeFoundation = "androidx.compose.foundation:foundation:1.2.0-alpha06"
    const val composeIconsCore = "androidx.compose.material:material-icons-core:1.2.0-alpha06"
    const val composeIconsExt = "androidx.compose.material:material-icons-extended:1.2.0-alpha06"
    const val composeMaterial = "androidx.compose.material:material:1.2.0-alpha06"
    const val composeUi = "androidx.compose.ui:ui:1.2.0-alpha06"
    const val composeUiTooling = "androidx.compose.ui:ui-tooling:1.2.0-alpha06"
    const val composeViewmodel = "androidx.lifecycle:lifecycle-viewmodel-compose:2.5.0-alpha05"
    ...
    const val kotlinReflect = "org.jetbrains.kotlin:kotlin-reflect:1.6.20-RC2"
