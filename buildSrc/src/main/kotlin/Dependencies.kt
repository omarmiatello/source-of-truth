...
object Lib {
    const val androidxActivityKtx = "androidx.activity:activity-ktx:1.4.0-rc01"
    ...
    const val androidxCoreKtx = "androidx.core:core-ktx:1.7.0-rc01"
    ...
    const val composeFoundation = "androidx.compose.foundation:foundation:1.1.0-alpha06"
    const val composeIconsCore = "androidx.compose.material:material-icons-core:1.1.0-alpha06"
    const val composeIconsExt = "androidx.compose.material:material-icons-extended:1.1.0-alpha06"
    const val composeMaterial = "androidx.compose.material:material:1.1.0-alpha06"
    const val composeUi = "androidx.compose.ui:ui:1.1.0-alpha06"
    const val composeUiTooling = "androidx.compose.ui:ui-tooling:1.1.0-alpha06"
