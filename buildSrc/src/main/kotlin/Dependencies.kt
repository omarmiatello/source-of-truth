...
object Lib {
    ...
    const val androidxFragmentKtx = "androidx.fragment:fragment-ktx:1.6.0-alpha07"
    const val androidxLifecycleRuntimeKtx = "androidx.lifecycle:lifecycle-runtime-ktx:2.6.0"
    ...
    const val androidxViewmodelKtx = "androidx.lifecycle:lifecycle-viewmodel-ktx:2.6.0"
    ...
    const val composeIconsCore = "androidx.compose.material:material-icons-core:1.4.0-rc01"
    const val composeIconsExt = "androidx.compose.material:material-icons-extended:1.4.0-rc01"
    const val composeMaterial = "androidx.compose.material:material:1.4.0-rc01"
    const val composeUi = "androidx.compose.ui:ui:1.4.0-rc01"
    const val composeUiTooling = "androidx.compose.ui:ui-tooling:1.4.0-rc01"
    ...
    const val kotlinReflect = "org.jetbrains.kotlin:kotlin-reflect:1.8.20-RC"
    ...
    const val testAndroidxRunner = "androidx.test:runner:1.5.3-alpha01"
