...
object Lib {
    ...
    const val androidxLifecycleRuntimeKtx = "androidx.lifecycle:lifecycle-runtime-ktx:2.8.0-alpha02"
    ...
    const val androidxViewmodelKtx = "androidx.lifecycle:lifecycle-viewmodel-ktx:2.8.0-alpha02"
    ...
    const val composeFoundation = "androidx.compose.foundation:foundation:1.7.0-alpha04"
    const val composeIconsCore = "androidx.compose.material:material-icons-core:1.7.0-alpha04"
    const val composeIconsExt = "androidx.compose.material:material-icons-extended:1.7.0-alpha04"
    const val composeMaterial = "androidx.compose.material:material:1.7.0-alpha04"
    const val composeUi = "androidx.compose.ui:ui:1.7.0-alpha04"
    const val composeUiTooling = "androidx.compose.ui:ui-tooling:1.7.0-alpha04"
    const val composeViewmodel = "androidx.lifecycle:lifecycle-viewmodel-compose:2.8.0-alpha02"
