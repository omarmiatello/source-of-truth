...
object Lib {
    ...
    const val androidxCoreKtx = "androidx.core:core-ktx:1.15.0-alpha01"
    const val androidxFragmentKtx = "androidx.fragment:fragment-ktx:1.8.0"
    const val androidxLifecycleRuntimeKtx = "androidx.lifecycle:lifecycle-runtime-ktx:2.8.2"
    ...
    const val androidxViewmodelKtx = "androidx.lifecycle:lifecycle-viewmodel-ktx:2.8.2"
    ...
    const val composeFoundation = "androidx.compose.foundation:foundation:1.7.0-beta03"
    const val composeIconsCore = "androidx.compose.material:material-icons-core:1.7.0-beta03"
    const val composeIconsExt = "androidx.compose.material:material-icons-extended:1.7.0-beta03"
    const val composeMaterial = "androidx.compose.material:material:1.7.0-beta03"
    const val composeUi = "androidx.compose.ui:ui:1.7.0-beta03"
    const val composeUiTooling = "androidx.compose.ui:ui-tooling:1.7.0-beta03"
    const val composeViewmodel = "androidx.lifecycle:lifecycle-viewmodel-compose:2.8.2"
    ...
    const val kotlinReflect = "org.jetbrains.kotlin:kotlin-reflect:2.0.20-Beta1"
    ...
    const val testAndroidxEspresso = "androidx.test.espresso:espresso-core:3.6.0-rc01"
    const val testAndroidxExtJunit = "androidx.test.ext:junit:1.2.0-rc01"
    const val testAndroidxRules = "androidx.test:rules:1.6.0-rc01"
    const val testAndroidxRunner = "androidx.test:runner:1.6.0-rc01"
