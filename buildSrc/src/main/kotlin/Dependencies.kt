...
object Lib {
    const val androidxActivityKtx = "androidx.activity:activity-ktx:1.7.0-alpha01"
    ...
    const val composeActivity = "androidx.activity:activity-compose:1.7.0-alpha01"
    const val composeFoundation = "androidx.compose.foundation:foundation:1.3.0-rc01"
    const val composeIconsCore = "androidx.compose.material:material-icons-core:1.3.0-rc01"
    const val composeIconsExt = "androidx.compose.material:material-icons-extended:1.3.0-rc01"
    const val composeMaterial = "androidx.compose.material:material:1.3.0-rc01"
    const val composeUi = "androidx.compose.ui:ui:1.3.0-rc01"
    const val composeUiTooling = "androidx.compose.ui:ui-tooling:1.3.0-rc01"
    ...
    const val testAndroidxEspresso = "androidx.test.espresso:espresso-core:3.5.0-beta01"
    const val testAndroidxExtJunit = "androidx.test.ext:junit:1.1.4-beta01"
    const val testAndroidxRules = "androidx.test:rules:1.4.1-beta01"
    const val testAndroidxRunner = "androidx.test:runner:1.5.0-beta01"
