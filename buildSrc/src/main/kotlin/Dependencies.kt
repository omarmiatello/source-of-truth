...
object Lib {
    const val androidxActivityKtx = "androidx.activity:activity-ktx:1.3.0-alpha07"
    ...
    const val androidxCoreKtx = "androidx.core:core-ktx:1.6.0-alpha02"
    const val androidxFragmentKtx = "androidx.fragment:fragment-ktx:1.3.3"
    const val androidxLifecycleRuntimeKtx = "androidx.lifecycle:lifecycle-runtime-ktx:2.4.0-alpha01"
    ...
    const val composeAccompanistCoil = "com.google.accompanist:accompanist-coil:0.8.1"
    ...
    const val composeIconsExt = "androidx.compose.material:material-icons-extended:1.0.0-beta05"
    const val composeMaterial = "androidx.compose.material:material:1.0.0-beta05"
    const val composeUi = "androidx.compose.ui:ui:1.0.0-beta05"
    const val composeUiTooling = "androidx.compose.ui:ui-tooling:1.0.0-beta05"
    const val composeViewmodel = "androidx.lifecycle:lifecycle-viewmodel-compose:1.0.0-alpha04"
    const val coroutinesAndroid = "org.jetbrains.kotlinx:kotlinx-coroutines-android:1.5.0-RC"
    ...
    const val testAndroidxEspresso = "androidx.test.espresso:espresso-core:3.4.0-alpha06"
    const val testAndroidxExtJunit = "androidx.test.ext:junit:1.1.3-alpha06"
    const val testAndroidxRules = "androidx.test:rules:1.4.0-alpha06"
    const val testAndroidxRunner = "androidx.test:runner:1.4.0-alpha06"
